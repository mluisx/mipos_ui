...
import com.mipos.asyncs.TwitterConnectAsync;
...
public class SalesMarketingActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sales_marketing_activity);
...
//    				startActivity(i);
	...
	public void updateLoginStatus() {
		TwitterConnectAsync twitterConnect = new TwitterConnectAsync(this);
		twitterConnect.setPrefs(prefs);
		twitterConnect.execute();
	}
