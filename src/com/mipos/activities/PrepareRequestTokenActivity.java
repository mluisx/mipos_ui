...
import com.mipos.twitter.OAuthRequestTokenTask;
import com.mipos.twitter.TwitterConstants;
	...
	public class RetrieveAccessTokenTask extends AsyncTask<Uri, Void, Void> {
		...
		protected Void doInBackground(Uri...params) {
			...
			try {
				...
				context.startActivity(new Intent(context,SalesMarketingActivity.class));
